...
## 4. How can CoWIN be protected from these types of tools?

Below are some of my observations of CoWIN site based on the response I have analysed while writing this tool and also multiple articles that were referred. 
...
I have borrwed good ideas from various projects to make cowin4all more robust. Following are the users and their projects from where I borrowed some ideas.
...
## 5. Other similar projects that you should check
...
## 6. Please donate and help others
